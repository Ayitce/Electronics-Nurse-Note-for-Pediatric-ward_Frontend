                ...
                <Grid container spacing={3} maxWidth={700}>
                    <Grid container item sm={6}>
                        ...
                        <Grid item sm={2} sx={{ mx: 0.5 }}>
                            ...
                            <Typography width={50} style={{ textAlign: 'center' }} sx={{ fontSize: 14 }}>Weak</Typography>

                        </Grid>
                        <Grid item sm={2} sx={{ mx: 0.5 }}>

                            <Typography style={{ textAlign: 'center' }} sx={{ fontSize: 14 }}>Bounding</Typography>
                    ...
                    <Grid container item sm={6}>
                        ...
                        <Grid item sm={2} sx={{ mx: 0.5 }}>
                            ...
                            <Typography width={50} style={{ textAlign: 'center' }} sx={{ fontSize: 14 }}>{'>'}=2</Typography>

                        </Grid>
                        <Grid item sm={2} sx={{ mx: 0.5 }}>

                            <Typography width={50} style={{ textAlign: 'center' }} sx={{ fontSize: 14 }}>{'<'}1(Flash)</Typography>
                    ...
                    <Grid container item sm={6}>
                        ...
                        <Grid item sm={2} sx={{ mx: 0.5 }}>
                            ...
                            <Typography width={50} style={{ textAlign: 'center' }} sx={{ fontSize: 14 }}>Decrease of Lower Lobes</Typography>

                        </Grid>
                        <Grid item sm={2} sx={{ mx: 0.5 }}>

                            <Typography width={50} style={{ textAlign: 'center' }} sx={{ fontSize: 14 }}>Decrease in All Areas</Typography>

                        </Grid>
                        <Grid item sm={2} sx={{ mx: 0.5 }}>

                            <Typography width={50} style={{ textAlign: 'center' }} sx={{ fontSize: 14 }}>Absent or Poor</Typography>
                    ...
                    <Grid container item sm={6}>
                        ...
                        <Grid item sm={2} sx={{ mx: 0.5 }}>
                            ...
                            <Typography width={50} style={{ textAlign: 'center' }} sx={{ fontSize: 14 }}>Forced Expitation</Typography>

                        </Grid>
                        <Grid item sm={2} sx={{ mx: 0.5 }}>

                            <Typography width={50} style={{ textAlign: 'center' }} sx={{ fontSize: 14 }}>Only Expiratory</Typography>

                        </Grid>
                        <Grid item sm={2} sx={{ mx: 0.5 }}>

                            <Typography width={50} style={{ textAlign: 'center' }} sx={{ fontSize: 14 }}>Inspire and Expiratory</Typography>

                        </Grid>
                        <Grid item sm={2} sx={{ mx: 0.5 }}>

                            <Typography width={50} style={{ textAlign: 'center' }} sx={{ fontSize: 14 }}>Audible</Typography>
